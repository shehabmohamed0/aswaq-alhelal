...
import '../features/auth/domain/usecases/link_email_and_password.dart' as _i134;
import '../features/auth/domain/usecases/log_out.dart' as _i136;
...
import '../features/auth/presentation/bloc/app_status/app_bloc.dart' as _i163;
...
import '../features/home/data/repositories/items_repository_impl.dart' as _i46;
import '../features/home/domain/repositories/items_repository.dart' as _i45;
import '../features/home/domain/usecases/get_items.dart' as _i122;
import '../features/home/presentation/cubit/items/items_cubit.dart' as _i132;
...
import '../features/orders/domain/usecases/place_order.dart' as _i138;
...
import '../features/work_institutions/presentation/cubit/work_institutions_cubit.dart'
    as _i172;
import 'register_module.dart' as _i173; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i56.NotificationsLocalApi>(
      () => _i56.NotificationsLocalApiImpl(get<_i11.SharedPreferences>()));
  ...
  gh.lazySingleton<_i64.ProfileRepository>(() => _i65.ProfileRepositoryImpl(
      get<_i61.ProfileApiService>(), get<_i17.NetworkInfo>()));
  gh.lazySingleton<_i66.RecruitmentApiService>(() =>
      _i66.RecruitmentApiServiceImpl(
          get<_i4.FirebaseFirestore>(), get<_i67.FirebaseFunctions>()));
  ...
  gh.lazySingleton<_i69.RecruitmentRepository>(() =>
      _i70.RecruitmentRepositoryImpl(
          get<_i66.RecruitmentApiService>(), get<_i17.NetworkInfo>()));
  ...
  gh.lazySingleton<_i73.SearchItem>(
      () => _i73.SearchItem(get<_i47.ItemsRepository>()));
  ...
  gh.lazySingleton<_i84.UpdateInstitutionItem>(
      () => _i84.UpdateInstitutionItem(get<_i47.ItemsRepository>()));
  ...
  gh.lazySingleton<_i86.UpdatePhoneNumber>(
      () => _i86.UpdatePhoneNumber(get<_i64.ProfileRepository>()));
  gh.factory<_i87.UpdatePhoneVerificationCubit>(() =>
      _i87.UpdatePhoneVerificationCubit(
          get<_i86.UpdatePhoneNumber>(), get<_i75.SmsAutoFill>()));
  gh.lazySingleton<_i88.UpdateProfile>(
      () => _i88.UpdateProfile(get<_i64.ProfileRepository>()));
  ...
  gh.lazySingleton<_i97.AddInstitutionItem>(
      () => _i97.AddInstitutionItem(get<_i47.ItemsRepository>()));
  ...
  gh.lazySingleton<_i102.AddRefAndInstitutionItem>(
      () => _i102.AddRefAndInstitutionItem(get<_i47.ItemsRepository>()));
  ...
  gh.lazySingleton<_i112.CheckIfSeenBefore>(
      () => _i112.CheckIfSeenBefore(get<_i76.StartUpRepository>()));
  gh.lazySingleton<_i113.DeclineJobOffer>(
      () => _i113.DeclineJobOffer(get<_i50.JobsOffersRepository>()));
  ...
  gh.lazySingleton<_i115.GetAddressInstitutions>(
      () => _i115.GetAddressInstitutions(get<_i39.InstitutionsRepository>()));
  gh.lazySingleton<_i116.GetAddresses>(
      () => _i116.GetAddresses(get<_i104.AddressesRepository>()));
  gh.lazySingleton<_i117.GetCurrentLocation>(
      () => _i117.GetCurrentLocation(get<_i104.AddressesRepository>()));
  gh.lazySingleton<_i118.GetEmployees>(
      () => _i118.GetEmployees(get<_i69.RecruitmentRepository>()));
  gh.lazySingleton<_i119.GetInstitutionItems>(
      () => _i119.GetInstitutionItems(get<_i47.ItemsRepository>()));
  gh.lazySingleton<_i120.GetInstitutionOrders>(() =>
      _i120.GetInstitutionOrders(get<_i33.InstitutionOrdersRepository>()));
  gh.lazySingleton<_i121.GetInstitutionReceipts>(() =>
      _i121.GetInstitutionReceipts(get<_i36.InstitutionReceiptsRepository>()));
  gh.lazySingleton<_i122.GetItems>(
      () => _i122.GetItems(get<_i45.ItemsRepository>()));
  gh.lazySingleton<_i123.GetJobsOffers>(
      () => _i123.GetJobsOffers(get<_i50.JobsOffersRepository>()));
  gh.lazySingleton<_i124.GetSentJobOffers>(
      () => _i124.GetSentJobOffers(get<_i69.RecruitmentRepository>()));
  gh.lazySingleton<_i125.GetUnitSuggestions>(
      () => _i125.GetUnitSuggestions(get<_i79.UnitsRepository>()));
  gh.lazySingleton<_i126.GetUserOrders>(
      () => _i126.GetUserOrders(get<_i91.UserOrdersRepository>()));
  ...
  gh.factory<_i128.InstitutionJobsOffersCubit>(() =>
      _i128.InstitutionJobsOffersCubit(get<_i124.GetSentJobOffers>(),
          get<_i74.SendJobOffer>(), get<_i72.RemoveJobOffer>()));
  gh.factory<_i129.InstitutionOrdersCubit>(() => _i129.InstitutionOrdersCubit(
      get<_i120.GetInstitutionOrders>(), get<_i85.UpdateInstitutionOrder>()));
  ...
  gh.factory<_i132.ItemsCubit>(() => _i132.ItemsCubit(get<_i122.GetItems>()));
  gh.factory<_i133.JobsOffersCubit>(() => _i133.JobsOffersCubit(
      get<_i123.GetJobsOffers>(),
      get<_i94.AcceptJobOffer>(),
      get<_i113.DeclineJobOffer>()));
  gh.lazySingleton<_i134.LinkEmailAndPassword>(
      () => _i134.LinkEmailAndPassword(get<_i110.AuthRepository>()));
  gh.factory<_i135.LocationWidgetCubit>(
      () => _i135.LocationWidgetCubit(get<_i117.GetCurrentLocation>()));
  gh.lazySingleton<_i136.LogOut>(
      () => _i136.LogOut(get<_i110.AuthRepository>()));
  gh.factory<_i137.NotificationsBloc>(
      () => _i137.NotificationsBloc(get<_i57.NotificationsRepository>()));
  gh.lazySingleton<_i138.PlaceOrder>(
      () => _i138.PlaceOrder(get<_i91.UserOrdersRepository>()));
  gh.lazySingleton<_i139.RegisterFcmDeviceToken>(
      () => _i139.RegisterFcmDeviceToken(get<_i76.StartUpRepository>()));
  gh.lazySingleton<_i140.RemoveAddress>(
      () => _i140.RemoveAddress(get<_i104.AddressesRepository>()));
  ...
  gh.lazySingleton<_i142.SignInWithPhone>(
      () => _i142.SignInWithPhone(get<_i110.AuthRepository>()));
  gh.factory<_i143.StartUpCubit>(
      () => _i143.StartUpCubit(get<_i112.CheckIfSeenBefore>()));
  ...
  gh.factory<_i148.UserOrdersBloc>(() => _i148.UserOrdersBloc(
      get<_i126.GetUserOrders>(), get<_i85.UpdateInstitutionOrder>()));
  ...
  gh.factory<_i155.AddEmailVerificationCubit>(() =>
      _i155.AddEmailVerificationCubit(
          get<_i134.LinkEmailAndPassword>(), get<_i75.SmsAutoFill>()));
  ...
  gh.factory<_i161.AddUnitBloc>(() => _i161.AddUnitBloc(
      get<_i125.GetUnitSuggestions>(), get<_i103.AddUnitToReference>()));
  gh.factory<_i162.AddressesCubit>(
      () => _i162.AddressesCubit(get<_i116.GetAddresses>()));
  gh.factory<_i163.AppBloc>(
      () => _i163.AppBloc(authRepository: get<_i110.AuthRepository>()));
  gh.factory<_i164.ClientInstitutionsCubit>(() => _i164.ClientInstitutionsCubit(
      get<_i26.GetClientInstitutionItems>(), get<_i138.PlaceOrder>()));
  gh.factory<_i165.EmployeesCubit>(() => _i165.EmployeesCubit(
      get<_i118.GetEmployees>(), get<_i71.RemoveEmployee>()));
  ...
  gh.lazySingleton<_i169.UpdateInstitution>(
      () => _i169.UpdateInstitution(get<_i146.UserInstitutionsRepository>()));
  gh.factory<_i170.UpdatePhoneCubit>(
      () => _i170.UpdatePhoneCubit(get<_i149.VerifyPhoneNumber>()));
  gh.factory<_i171.UserInstitutionsCubit>(
      () => _i171.UserInstitutionsCubit(get<_i166.GetUserInstitutions>()));
  gh.factory<_i172.WorkInstitutionsCubit>(
      () => _i172.WorkInstitutionsCubit(get<_i167.GetWorkInstitutions>()));
  return get;
}

class _$RegisterModule extends _i173.RegisterModule {}
