...
part 'client_institution_state.dart';

@injectable
class ClientInstitutionCubit extends Cubit<ClientInstitutionState> {
  ClientInstitutionCubit(this._getClientInstitutionItems, this._placeOrder)
      : super(const ClientInstitutionState());
