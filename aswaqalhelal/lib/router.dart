...
import 'package:geo_presentation/features/presentation/bloc/select_location_map/select_location_map_bloc.dart';
import 'package:geo_presentation/features/presentation/cubit/addresses/addresses_cubit.dart';
import 'package:geo_presentation/features/presentation/pages/addresses/addresses_page.dart';
import 'package:geo_presentation/features/presentation/pages/select_location_map/select_location_map_page.dart';
      ...
      case Routes.institutionItems:
        return _getPageRoute(
          ...
          builder: (context) => BlocProvider<InstitutionItemsCubit>(
            create: (context) =>
                locator()..getInstitutionsItems(settings.arguments as String),
